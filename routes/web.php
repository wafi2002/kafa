...
Route::view('kafa/dashboard', 'ManageRegistration.Kafa Admin.dashboard')->name('kafa.dashboard')->middleware('kafa');
Route::view('muip/dashboard', 'ManageRegistration.Muip Admin.dashboard')->name('muip.dashboard')->middleware('muip');
Route::view('parent/dashboard', 'ManageRegistration.Parent.dashboard')->name('parent.dashboard')->middleware('parent');
Route::view('teacher/dashboard', 'ManageRegistration.Teacher.dashboard')->name('teacher.dashboard')->middleware('teacher');
